...
parser = argparse.ArgumentParser('train_dense.py')
parser.add_argument('config', nargs='?', default='/scratch/SparseNOvA/config/sparse_nova_dense_mobilenet.yaml')
...
#trainer.load_state_dict(state_dict='/scratch/SparseNOvA/params/StepLR2/checkpoints/model_checkpoint_DenseMobileNet_3605824_205c57fbb1_haejunoh.best.pth.tar')
