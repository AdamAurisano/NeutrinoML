...
class SparseSegmentation(nn.Module):
    ...
    def __init__(self, n_dims=2, extent=6000, unet_depth=5, unet_reps=1, n_feats=32, res_blocks=False, n_classes=7):
        ...
        self.model = scn.Sequential().add(
            ...
            scn.SubmanifoldConvolution(n_dims, 1, n_feats, 3, False)).add(
